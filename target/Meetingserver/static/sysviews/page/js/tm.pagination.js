    ...
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            function getPagination(newValue, oldValue) {
               ...
               // scope.$parent.$emit('changeSuccess');
              //当分页改变的时候调用的方法(for论坛选人分页),别的模块没用就不调用
            	if(scope.$parent.changeMyPage){
            		scope.$parent.changeMyPage();
            	}
            }
//            scope.$parent.$on('changeSuccess',function(){
//            	alert("aaaaaaaa");
//            	if(scope.$parent.changeMyPage){
//            		scope.$parent.changeMyPage();
//            	}
...
//            scope.$watch('conf.currentPage + conf.itemsPerPage', function() {
//                //当分页改变的时候调用的方法(for论坛选人分页),别的模块没用就不调用
//            	if(scope.$parent.changeMyPage){
//            		scope.$parent.changeMyPage();
//            	}
