                        ...
                        <div class="panel-heading">
								<div id="dataTables-example_filter" class="dataTables_filter">
									...
									<security:authorize access="hasRole('ROLE_SYS_GROUP_DELETE')">
										<%-- <a href="${ctx }${path}/sysGroup/deleteList" class="btn btn-danger" >删除</a> --%>
										<a href="javaScript:void(0);" ng-click="sysGroupDeleteAll()" class="btn btn-danger">删除</a>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tr>
                                    	<th>
											<label class="i-checks m-b-none">
												<input type="checkbox" ng-model="master" ng-click="all(master,items)">
                            				</label>
									   	</th>
                                       	<th>序号</th>
									   	<th>名称</th>
                                ...
                                <tbody>
									<tr ng-repeat="group in items">
										<td>
											<label class="i-checks m-b-none">
				                                <input id={{group.id}} type="checkbox" ng-model="x" ng-checked="master" ng-click="chk(group.id,x)">
				                            </label>
										</td>
