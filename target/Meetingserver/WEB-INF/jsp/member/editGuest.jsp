...
<c:choose>
	<c:when test="${empty id}">
		<script src="${ctx }/static/sysviews/member/js/addGuest.js"></script>
	</c:when>
	<c:otherwise>
		<script src="${ctx }/static/sysviews/member/js/editGuest.js"></script>
	</c:otherwise>
</c:choose>
		...
		<form class="form-horizontal" role="form">
			...
			<div class="form-group"> 
  			...
  			<div class="form-group"> 
				...
				<div class="col-sm-3"> 
					<input type="text" placeholder="单位" class="form-control" autofocus id="workPlace" name="workPlace" ng-model="guest.workPlace" maxlength="220" />
				</div> 
