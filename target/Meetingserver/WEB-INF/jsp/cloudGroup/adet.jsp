			...
			<div id="page-wrapper">
				<form class="form-horizontal" role="form">
					<div class="panel panel-default">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" ng-model="cloudGroup.fgName" maxlength="200">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div  class="col-sm-8">
								<textarea ng-model="cloudGroup.fgAppUserNames" disabled rows="5" style="background-color:#FEFFD6;cursor:pointer;width:550px;" id="outNames"></textarea>
				...
				<div class="form-group breadcrumb" style="width:100%;float:left;margin:10px;">
					<div class="col-sm-offset-2 col-sm-10">
						...
						<a class="btn btn-success" style="width: 160px;" ng-click="addAndEditButton()">确认</a>
					</div>
				</div>
			</div>
		</div>
