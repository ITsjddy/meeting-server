...
/* query style */
.inputQry{
	background:url(${ctx}/images/query.png) no-repeat 140px 3px;
			...
			<div ng-repeat="guestSer in lguestSer">
				<div class="form-group"> 
					...
					<div class="col-sm-6"> 
						...
						<input id="sername{{$index}}" class=" inputQry" type="text" ng-click="servicePerTree($index)" ng-model="guestSer.servicePersonnelName" 
