		...
		<div class="panel panel-default">
			...
			<div class="form-group"> 
  			...
  			<div class="form-group"> 
				...
				<div class="col-sm-8"> 
					<select class="form-control" name="plateId" ng-model="schedule.plateId">
  			...
  			<div class="form-group"> 
				...
				<div class="col-sm-3"> 
					<input type="text" placeholder="开始时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" class="form-control" autofocus id="startDate" name="startDate" ng-model="schedule.startDate"/>
				</div> 
				<label for="firstname" class="col-sm-2 control-label">结束时间：<font color="red">*</font></label> 
				<div class="col-sm-3"> 
					<input type="text" placeholder="结束时间" onclick="WdatePicker({minDate:'#F{$dp.$D(\'startDate\')}',dateFmt:'yyyy-MM-dd HH:mm'})" class="form-control" autofocus id="endDate" name="endDate" ng-model="schedule.endDate" />
				</div> 
  			</div>
			<div class="form-group"> 
				<%-- <label for="firstname" class="col-sm-2 control-label">论坛截止时间：<font color="red">*</font></label> 
  					<div class="col-sm-1"> 
  						<input type="text" placeholder="开始时间"  onclick="WdatePicker({dateFmt:'HH:mm'})" class="form-control" required autofocus name="startTime" id="startTime" ng-model="schedule.startTime" />
  						<input type="text" placeholder="开始时间" value="<fmt:formatDate value="{{schedule.startTimes}}" pattern="HH:mm"  onclick="WdatePicker({dateFmt:'HH:mm'})" class="form-control" required autofocus name="startTime" id="startTime" ng-model="schedule.startTimes" />
					</div> 
					<div class="col-sm-1"> 
  						<label for="firstname" class="col-sm-1 control-label">至</label> 
					</div> 
  					<div class="col-sm-1"> 
  						<input type="text" placeholder="结束时间"  onclick="WdatePicker({minDate:'#F{$dp.$D(\'startTime\')}',dateFmt:'HH:mm'})" class="form-control" required autofocus id="endTime" name="endTime" ng-model="schedule.endTime" />
  						<input type="text" placeholder="结束时间" value="<fmt:formatDate value="{{schedule.endTimes}}" pattern="HH:mm"  onclick="WdatePicker({minDate:'#F{$dp.$D(\'startTime\')}',dateFmt:'HH:mm'})" class="form-control" required autofocus name="endTime" ng-model="schedule.endTimes" />
					</div>  --%>
				<label for="firstname" class="col-sm-2 control-label">会场名称：<font color="red">*</font></label> 
				<div class="col-sm-3"> 
					<select class="form-control" ng-change="changeConHallId()" name="conHallId" ng-model="schedule.conHallId">
						<option value="">--请选择--</option>
  			...
  			<div class="form-group"> 
				...
				<div class="col-sm-3"> 
					<input type="text" placeholder="主办单位" class="form-control" autofocus  ng-model="schedule.hostUnit"/>
				</div> 
				<label for="firstname" class="col-sm-2 control-label">主办单位联系人：</label> 
				<div class="col-sm-3"> 
					<input type="text" placeholder="主办单位联系人" class="form-control" autofocus  ng-model="schedule.hostContact" />
				</div> 
  			</div>
  			<div class="form-group"> 
				<label for="firstname" class="col-sm-2 control-label">支持单位：</label> 
				<div class="col-sm-3"> 
					<input type="text" placeholder="支持单位" class="form-control" autofocus  ng-model="schedule.supportUnit"/>
				</div> 
				<label for="firstname" class="col-sm-2 control-label">协办单位：</label> 
				<div class="col-sm-3"> 
					<input type="text" placeholder="协办单位" class="form-control" autofocus  ng-model="schedule.coUnit" />
				</div> 
  			</div>
				<div class="form-group">
										...
										<!-- <td>
											<div class="btn-group">
												...
												<ul class="dropdown-menu">												  	
														...
														<li class="divider"></li>
														<li><a href="javaScript:void(0);" ng-click="deleteFromIds(guest.id)" class="btn btn-danger">删除</a></li>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<textarea type="text" placeholder="论坛描述" class="form-control"
								required autofocus ng-model="schedule.remark" maxlength="60" maxlength="1000" class="input-xlarge isSpace" rows="5" style="width:800px;resize:none;"></textarea>
						</div>
					</div>
				</div>
					...
					<div class="panel panel-default" id="guestDiv{{$index}}"
						...
						<div class="col-sm-3">
							<input type="text" placeholder="论坛名称({{languageData[$index].name}})" class="form-control"
								required autofocus ng-model="scheduleLan.name" maxlength="60" />
						</div>
						<label for="firstname" class="col-sm-2 control-label"> <!-- <div ng-if="conHall.language=='1'">会场名称：<font color="red">*</font></div><div ng-if="conHall.language=='2'">name：<font color="red">*</font></div> -->
						...
						<div class="col-sm-3">
							<input type="text" placeholder="论坛简称({{languageData[$index].name}})" class="form-control"
								required autofocus ng-model="scheduleLan.shortname" maxlength="60" />
						</div>
					</div>
					<div class="form-group">
						<label for="firstname" class="col-sm-2 control-label"> <!-- <div ng-if="conHall.language=='1'">会场名称：<font color="red">*</font></div><div ng-if="conHall.language=='2'">name：<font color="red">*</font></div> -->
						...
						<div class="col-sm-3">
							<input type="text" placeholder="主持人({{languageData[$index].name}})" class="form-control"
								required autofocus ng-model="scheduleLan.hostPerson" maxlength="60" />
						</div>
					</div>
					<div class="form-group">
						<label for="firstname" class="col-sm-2 control-label"> <!-- <div ng-if="conHall.language=='1'">会场名称：<font color="red">*</font></div><div ng-if="conHall.language=='2'">name：<font color="red">*</font></div> -->
						...
						<div class="col-sm-3">
							<textarea type="text" placeholder="论坛描述({{languageData[$index].name}})" class="form-control"
								required autofocus ng-model="scheduleLan.remark" maxlength="60" maxlength="1000" class="input-xlarge isSpace" rows="5" style="width:800px;resize:none;"></textarea>
						</div>
					</div>
					</div>
				</div>
