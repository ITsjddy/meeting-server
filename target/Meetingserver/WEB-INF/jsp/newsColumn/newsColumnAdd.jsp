	...
	<div id="page-wrapper">
		...
		<div class="panel panel-default">
			...
			<div class="form-group"> 
				...
				<div class="col-sm-3">
					<select class="form-control" ng-change="changeType()" name="type" ng-model="newsColumn.type">
				...
				<label for="firstname" class="col-sm-2 control-label">所属栏目：</label>
				<div class="col-sm-3">
					<select class="form-control" name="column" ng-model="newsColumn.columnId">
						<option value="">--请选择--</option>
