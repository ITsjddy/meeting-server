							...
							<div class="col-md-10">
								<div ng-repeat="topic in spAddressNames">
									<div class="form-group">
										...
										<div class="col-sm-3">
											<select class="form-control" ng-init="topic.topicType = topicTypesData[0].id" id="topicType{{$index + 1}}" ng-model="topic.topicType" ng-change="fchat.topicOnChange({{$index+1}},topic.topicType)">
