	...
	<div id="page-wrapper">
		<form class="form-horizontal" role="form">
			...
			<div class="panel panel-default">
				...
				<input type="hidden" ng-model="audience.language" disabled="disabled"/>
				...
				<div class="form-group"> 
					...
					<div class="col-sm-3"> 
						<input type="text" placeholder="邀请码" class="form-control" required autofocus ng-model="audience.invitationCode" maxlength="220" readonly="readonly"/>
					</div> 
					<label for="firstname" class="col-sm-2 control-label">用户名：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="用户名" class="form-control" autofocus ng-model="audience.userName" maxlength="220" readonly="readonly"/>
					</div> 
	  			</div> 
	  			<div class="form-group"> 
	  			<label for="firstname" class="col-sm-2 control-label">手机号：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="手机号" class="form-control" autofocus ng-model="audience.mobile" maxlength="220" readonly="readonly"/>
					</div>
					<label for="firstname" class="col-sm-2 control-label">email：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="email" class="form-control" autofocus ng-model="audience.email" maxlength="220" readonly="readonly"/>
					</div> 
	  			</div>
	  			<div class="form-group">
					<label for="firstname" class="col-sm-2 control-label">性别：</label> 
					<div class="col-sm-3"> 
						男&nbsp;<input type="radio" placeholder="性别" autofocus ng-model="audience.gender" value="1" ng-checked="isSelected(audience.gender)" disabled="disabled"/>&nbsp;&nbsp;
						女&nbsp;<input type="radio" placeholder="性别" autofocus ng-model="audience.gender" value="2" ng-checked="isSelected(audience.gender)" disabled="disabled"/>
					</div> 
	  			</div>
			</div>
			<div class="panel panel-default">
				<ul class="breadcrumb">
	  			...
	  			<div class="form-group"> 
					...
					<div class="col-sm-3"> 
						<input type="text" placeholder="姓名" class="form-control" required autofocus ng-model="audience.name" maxlength="220" readonly="readonly"/>
					</div> 
					<!-- <label for="firstname" class="col-sm-2 control-label">性别：</label> 
					<div class="col-sm-3"> 
	  			...
	  			<div class="form-group"> 
					...
					<div class="col-sm-3"> 
						<input type="text" placeholder="工作单位" class="form-control" autofocus ng-model="audience.workPlace" maxlength="220" readonly="readonly"/>
					</div> 
					<label for="firstname" class="col-sm-2 control-label">职位：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="职位" class="form-control" autofocus ng-model="audience.job" maxlength="220" readonly="readonly"/>
					</div> 
	  			</div>
	  			<div class="form-group"> 
	  				<label for="firstname" class="col-sm-2 control-label">单位简介：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="单位简介" class="form-control" autofocus id="unitExplain" name="unitExplain" ng-model="audience.unitExplain" maxlength="220" readonly="readonly"/>
					</div> 
					<label for="firstname" class="col-sm-2 control-label">个人简介：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="个人简介" class="form-control" autofocus id="introduction" name="introduction" ng-model="audience.introduction" maxlength="220" readonly="readonly"/>
					</div> 
	  			</div>
	  			<div class="form-group"> 
	  				<label for="firstname" class="col-sm-2 control-label">联系人：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="联系人" class="form-control" autofocus id="contactPerson" name="contactPerson" ng-model="audience.contactPerson" maxlength="220" readonly="readonly"/>
					</div> 
					<label for="firstname" class="col-sm-2 control-label">联系人电话：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="联系人电话" class="form-control" autofocus id="contactPhone" name="contactPhone" ng-model="audience.contactPhone" maxlength="220" readonly="readonly"/>
					</div> 
	  			</div>
			</div>
				<!-- 内容 -->
				...
				<div class="panel panel-default" id="audienceDiv{{$index}}" ng-show="languageData[$index].check">
					...
					<ul class="breadcrumb">
		  			...
		  			<div class="form-group"> 
						...
						<div class="col-sm-3"> 
							<input type="text" placeholder="姓名" class="form-control" required autofocus ng-model="audiencelan.name" maxlength="220" readonly="readonly"/>
						</div> 
		  			...
		  			<div class="form-group"> 
						...
						<div class="col-sm-3"> 
							<input type="text" placeholder="工作单位" class="form-control" autofocus ng-model="audiencelan.workPlace" maxlength="220" readonly="readonly"/>
						</div> 
						<label for="firstname" class="col-sm-2 control-label">职务({{languageData[$index].name}})：</label> 
						<div class="col-sm-3"> 
							<input type="text" placeholder="职务" class="form-control" autofocus ng-model="audiencelan.job" maxlength="220" readonly="readonly"/>
						</div> 
		  			</div>
		  			<div class="form-group"> 
						<label for="firstname" class="col-sm-2 control-label">单位简介({{languageData[$index].name}})：</label> 
						<div class="col-sm-3"> 
							<input type="text" placeholder="单位简介" class="form-control" autofocus ng-model="audiencelan.unitExplain" maxlength="220" readonly="readonly"/>
						</div> 
						<label for="firstname" class="col-sm-2 control-label">个人简介({{languageData[$index].name}})：</label> 
						<div class="col-sm-3"> 
							<input type="text" placeholder="个人简介" class="form-control" autofocus ng-model="audiencelan.introduction" maxlength="220" readonly="readonly"/>
						</div> 
		  			</div>
		  			<div class="form-group"> 
	  				<label for="firstname" class="col-sm-2 control-label">联系人({{languageData[$index].name}})：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="联系人" class="form-control" autofocus id="contactPerson" name="contactPerson" ng-model="audiencelan.contactPerson" maxlength="220" readonly="readonly"/>
					</div> 
					<label for="firstname" class="col-sm-2 control-label">联系人电话({{languageData[$index].name}})：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="联系人电话" class="form-control" autofocus id="contactPhone" name="contactPhone" ng-model="audiencelan.contactPhone" maxlength="220" readonly="readonly"/>
					</div> 
	  			</div>
				</div>
			</div>
