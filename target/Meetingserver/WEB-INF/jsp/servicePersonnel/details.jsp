		...
		<form class="form-horizontal" role="form">
			...
			<div class="form-group"> 
				...
				<div class="col-sm-8"> 
					...
					<input type="text" readonly="readonly" placeholder="邀请码" class="form-control" required autofocus id="language" name="language" ng-model="guest.language" maxlength="220" />
			...
			<div class="form-group"> 
				...
				<div class="col-sm-3"> 
					<input type="text"  readonly="readonly" placeholder="邀请码" class="form-control" required autofocus id="invitationCode" name="invitationCode" ng-model="guest.invitationCode" maxlength="220" />
				</div> 
				<label for="firstname" class="col-sm-2 control-label">手机号：</label> 
				<div class="col-sm-3"> 
					<input type="text" readonly="readonly" placeholder="手机号" class="form-control" autofocus id="mobile" name="mobile" ng-model="guest.mobile" maxlength="220" />
				</div> 
  			</div> 
  			<div class="form-group"> 
				<label for="firstname" class="col-sm-2 control-label">email：</label> 
				<div class="col-sm-3"> 
					<input type="text"  readonly="readonly" placeholder="email" class="form-control" autofocus id="email" name="email" ng-model="guest.email" maxlength="220" />
				</div> 
				<label for="firstname" class="col-sm-2 control-label">用户名：</label> 
				<div class="col-sm-3"> 
					<input type="text"  readonly="readonly" placeholder="用户名" class="form-control" autofocus id="userName" name="userName" ng-model="guest.userName" maxlength="220" />
				</div> 
  			</div>
  			<div class="form-group"> 
  			<label for="firstname" class="col-sm-2 control-label">密码：<font color="red">*</font></label> 
				<div class="col-sm-3"> 
					<input type="text"  readonly="readonly" placeholder="密码" class="form-control" required autofocus id="password" name="password" ng-model="guest.password" maxlength="220" />
				</div> 
				<label for="firstname" class="col-sm-2 control-label">姓名：<font color="red">*</font></label> 
				<div class="col-sm-3"> 
					<input type="text"  readonly="readonly" placeholder="姓名" class="form-control" required autofocus id="name" name="name" ng-model="guest.name" maxlength="220" />
				</div> 
...
<!-- 				</div>  -->
  			...
  			<div class="form-group"> 
				...
				<div class="col-sm-3"> 
					<input type="text"  readonly="readonly" placeholder="个人简介" class="form-control" required autofocus id="introduction" name="introduction" ng-model="guest.introduction" maxlength="220" />
				</div> 
				<label for="firstname" class="col-sm-2 control-label">所属团：<font color="red">*</font></label> 
				<div class="col-sm-3"> 
					<input type="text"  readonly="readonly" placeholder="所属团" class="form-control" required autofocus id="groupId" name="groupId" ng-model="guest.groupId" maxlength="220" />
				</div> 
<!-- 				<label for="firstname" class="col-sm-2 control-label">性别：</label>  -->
<!-- 				<div class="col-sm-3">  -->
<!-- 					男&nbsp;<input type="radio" placeholder="性别" autofocus id="gender" name="gender" ng-model="guest.gender" value="1" ng-checked="isSelected(guest.gender)"/>&nbsp;&nbsp; -->
...
<!-- 				</div>  -->
  			...
  			<div class="form-group"> 
				...
				<div class="col-sm-3"> 
					<input type="text"  readonly="readonly" placeholder="单位" class="form-control" autofocus id="companyId" name="companyId" ng-model="guest.companyId" maxlength="220" />
				</div> 
