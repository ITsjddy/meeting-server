...
<head>
	...
	<!-- 模块js -->
	<script src="${ctx }/static/sysviews/servicePersonnel/js/listsgroup.js"></script>
	<script type="text/javascript">
		function loadhref(id,action){
			window.location.href=action+"?groupid="+id;
		}
	</script>
</head>
...
<!-- 									<label>所属团: -->
<!-- 										<input type="search"  ng-model="searchParam.member_group" class="form-control input-sm"  -->
<!-- 											 aria-controls="dataTables-example"> -->
<!-- 									</label> -->
<!-- 									<label>单位/职务: -->
...
<!-- 									   <th>是否已扫描</th> -->
                                ...
                                <tbody>
									<tr ng-repeat="guest in items">
										...
										<td ng-bind="guest.introduction"></td>
										<td ng-bind="guest.companyId"></td>
										<td ng-bind="guest.groupId"></td>
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
												  	<security:authorize access="hasRole('ROLE_GUEST_EDIT')">
														<li><a href="${ctx }${path}/servicePersonnel/edit?id={{ guest.id }}" class="btn btn btn-info">编辑</a></li>
													</security:authorize>
													...
													<security:authorize access="hasRole('ROLE_GUEST_DETAILS')">
														<li class="divider"></li>
														<li><a href="${ctx }${path}/servicePersonnel/details?id={{ guest.id }}" class="btn btn btn-info">详情</a></li>
													</security:authorize>
												</ul>
									    	</div>
										</td>
