...
<div class="cwerror">
  ...
  <div class="cwerror_nr">
    <div class="nr_top">Ooops:no permission to access the current page</div>
    ...
    <div class="nr_min" id="text">
      ...
      <div class="else"><div class="min_choose"><a href="${ctx }/dispatcher/login/loginOut">退出登录</a></div>
     </div>
    </div>
  </div>
</div>
