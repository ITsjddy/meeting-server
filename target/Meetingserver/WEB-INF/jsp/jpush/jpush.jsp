			...
			<div id="page-wrapper">
				<form class="form-horizontal" role="form">
					<div class="panel panel-default">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" ng-model="jpushEntiy.jpTitle" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="ds_host">中文正文：</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" ng-model="jpushEntiy.jpText" maxlength="200">
							</div>
						</div>
						<div class="form-group ">
							<!-- <hr/> -->
							...
							<div class="col-md-10">
								<div ng-repeat="topic in spAddressNames">
									<div class="form-group">
										...
										<div class="col-sm-3">
											<select class="form-control" ng-init="topic.languageId = topicTypesData[0].id" id="topicType{{$index + 1}}" ng-model="topic.languageId" ng-change="fchat.topicOnChange({{$index+1}},topic.languageId)">
													<option ng-repeat="type in topicTypesData" value="{{type.id}}" >{{type.content}}</option>
											</select>
										</div>
									...
									<div id="optionsDiv{{topicMark+1}}" style="display: none;">
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control" ng-model="topic.jpTitle" id="topic{{topicMark+1}}Option{{$index + 1}}" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-1 control-label" for="ds_host">正文：</label>
											<div class="col-sm-5">
												<input type="text" class="form-control" ng-model="topic.jpText" id="topic{{topicMark+11}}Option{{$index + 1}}" />
											</div>
										</div>
									</div>
								</div>
				...
				<div class="form-group breadcrumb" style="width:100%;float:left;margin:10px;">
					<div class="col-sm-offset-2 col-sm-10">
						<a class="btn btn-success" style="width: 160px;" ng-click="addJpushEntiy()">推送</a>
					</div>
				</div>
			</div>
		</div>
