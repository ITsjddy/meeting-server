...
<meta charset="utf-8">
<title>App版本修改</title>
<script src="${ctx }/static/sysviews/appVersion/js/edit.js"></script>
			...
			<form class="form-horizontal" role="form" name="form" enctype="multipart/form-data" ng-submit="appVersionEditSave()">
				...
				<fieldset>
					<div class="form-group">
						...
						<div class="col-sm-3">
							<select name="type" required class="form-control" ng-model="appVersion.type" ng-change="changeAppVersionType()">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input class="form-control" type="text" name="versionName" ng-model="appVersion.versionName"  required/>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input readonly="readonly" class="form-control" type="text" name="versionNum" 
							 ng-model="appVersion.versionNum" placeholder=""  required/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							...
							<div id="qrCodeFileQueue" style="width:300px; padding-right: 3px;">
								...
								<span id="imageQrCode"><img id="imgvo" src="${strpath}{{appVersion.qr_code}}" style="width:70px; height:70px;"/></span>
							</div>
						</div>
					</div>
					...
					<div id="picOneDiv" style="display: none;" class="form-group">
						...
						<div class="col-sm-3">
							...
							<div id="picOneFileQueue" style="width:300px; padding-right: 3px;">
								...
								<span id="imagePicOne"><img id="imgvo" src="${strpath}{{appVersion.picOne}}" style="width:70px; height:70px;"/></span>
							</div>
						</div>
					</div>
					<div id="picTwoDiv" style="display: none;" class="form-group">
						...
						<div class="col-sm-3">
							...
							<div id="picTwoFileQueue" style="width:300px; padding-right: 3px;">
								...
								<span id="imagePicTwo"><img id="imgvo" src="${strpath}{{appVersion.picTwo}}" style="width:70px; height:70px;"/></span>
							</div>
						</div>
					</div>
					<div class="form-group">
