		...
		<div class="panel panel-default">
			...
			<div class="form-group"> 
  			...
  			<div class="form-group"> 
				...
				<div class="col-sm-3"> 
					<input type="text" readonly="readonly" placeholder="开始时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" class="form-control"  id="startDate" name="startDate" ng-model="schedule.startDate"/>
				</div> 
				<label for="firstname" class="col-sm-2 control-label">结束时间：<font color="red">*</font></label> 
				<div class="col-sm-3"> 
					<input type="text" readonly="readonly" placeholder="结束时间" onclick="WdatePicker({minDate:'#F{$dp.$D(\'startDate\')}',dateFmt:'yyyy-MM-dd HH:mm'})" class="form-control"  id="endDate" name="endDate" ng-model="schedule.endDate" />
				</div> 
  			</div>
			<div class="form-group"> 
  			...
  			<div class="form-group"> 
				...
				<div class="col-sm-3"> 
					<input type="text" readonly="readonly" placeholder="会场联系人" class="form-control" ng-model="conHallPerson"  readonly="readonly"/>
				</div> 
  			...
  			<!-- <div class="form-group"> 
				...
				<div class="col-sm-3"> 
					<input type="text" readonly="readonly" placeholder="主办单位" class="form-control"   ng-model="schedule.hostUnit"/>
				</div> 
				<label for="firstname" class="col-sm-2 control-label">主办单位联系人：</label> 
				<div class="col-sm-3"> 
					<input type="text" readonly="readonly" placeholder="主办单位联系人" class="form-control"   ng-model="schedule.hostContact" />
				</div> 
  			</div>
  			<div class="form-group"> 
				<label for="firstname" class="col-sm-2 control-label">支持单位：</label> 
				<div class="col-sm-3"> 
					<input type="text" readonly="readonly" placeholder="支持单位" class="form-control"   ng-model="schedule.supportUnit"/>
				</div> 
				<label for="firstname" class="col-sm-2 control-label">协办单位：</label> 
				<div class="col-sm-3"> 
					<input type="text" readonly="readonly" placeholder="协办单位" class="form-control"   ng-model="schedule.coUnit" />
				</div> 
  			</div>
				<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" readonly="readonly" placeholder="论坛简称" class="form-control"
								required  ng-model="schedule.shortname" maxlength="60" />
						</div>
					</div>
					<div class="form-group">
						<label for="firstname" class="col-sm-2 control-label"> <!-- <div ng-if="conHall.language=='1'">会场名称：<font color="red">*</font></div><div ng-if="conHall.language=='2'">name：<font color="red">*</font></div> -->
						...
						<div class="col-sm-3">
							<input type="text" readonly="readonly" placeholder="主持人" class="form-control"
								required  ng-model="schedule.hostPerson" maxlength="60" />
						</div>
					</div>
					<div class="form-group">
						<label for="firstname" class="col-sm-2 control-label"> <!-- <div ng-if="conHall.language=='1'">会场名称：<font color="red">*</font></div><div ng-if="conHall.language=='2'">name：<font color="red">*</font></div> -->
						...
						<div class="col-sm-3">
							<textarea type="text" placeholder="论坛描述" class="form-control"
								required  readonly="readonly" ng-model="schedule.remark" maxlength="60" maxlength="1000" class="input-xlarge isSpace" rows="5" style="width:800px;resize:none;"></textarea>
						</div>
					</div>
				</div>
					...
					<div class="panel panel-default" id="guestDiv{{$index}}"
						...
						<div class="col-sm-3">
							<input type="text" placeholder="论坛名称({{languageData[$index].name}})" class="form-control"
								required  ng-model="scheduleLan.name" readonly="readonly" maxlength="60" />
						</div>
						<label for="firstname" class="col-sm-2 control-label"> <!-- <div ng-if="conHall.language=='1'">会场名称：<font color="red">*</font></div><div ng-if="conHall.language=='2'">name：<font color="red">*</font></div> -->
						...
						<div class="col-sm-3">
							<input type="text" placeholder="论坛简称({{languageData[$index].name}})" class="form-control"
								required  ng-model="scheduleLan.shortname" readonly="readonly" maxlength="60" />
						</div>
					</div>
					<div class="form-group">
						<label for="firstname" class="col-sm-2 control-label"> <!-- <div ng-if="conHall.language=='1'">会场名称：<font color="red">*</font></div><div ng-if="conHall.language=='2'">name：<font color="red">*</font></div> -->
						...
						<div class="col-sm-3">
							<input type="text" placeholder="主持人({{languageData[$index].name}})" class="form-control"
								required  ng-model="scheduleLan.hostPerson" readonly="readonly" maxlength="60" />
						</div>
					</div>
					<div class="form-group">
						<label for="firstname" class="col-sm-2 control-label"> <!-- <div ng-if="conHall.language=='1'">会场名称：<font color="red">*</font></div><div ng-if="conHall.language=='2'">name：<font color="red">*</font></div> -->
						...
						<div class="col-sm-3">
							<textarea type="text" placeholder="论坛描述({{languageData[$index].name}})" class="form-control"
								required  readonly="readonly" ng-model="scheduleLan.remark" maxlength="60" maxlength="1000" class="input-xlarge isSpace" rows="5" style="width:800px;resize:none;"></textarea>
						</div>
					</div>
					</div>
				</div>
