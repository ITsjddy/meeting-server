                        ...
                        <div class="panel-heading">
								<div id="dataTables-example_filter" class="dataTables_filter">
									<label>名称:<input type="search"  ng-model="searchParam.name"
										...
										<label>
										类型:<select class="form-control" ng-model="searchParam.type">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
									...
									<td><input type="checkbox" ng-model="newsColumn.check" ng-change="idSelect(newsColumn.id,newsColumn.check)" ></td>
