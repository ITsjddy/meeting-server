...
<head>
	<meta charset="utf-8"> 
	<title>新闻栏目添加页面</title>
	<!-- 模块js -->
	<script src="${ctx }/static/sysviews/newsColumn/js/add.js"></script>
</head>
<body  ng-app="newsColumnApp" ng-controller="newsColumnController">
<ul class="breadcrumb"><li>新闻栏目添加</li></ul>
<div id="wrapper">
	<div id="page-wrapper">
		...
		<div class="panel panel-default">
			...
			<div class="form-group"> 
				<label for="firstname" class="col-sm-2 control-label">语言类型：<font
			...
			<div class="form-group"> 
				<label for="firstname" class="col-sm-2 control-label">数据类别：<font
						color="red">*</font></label>
				<div class="col-sm-3">
					<select class="form-control" required ng-change="changeType()" name="type" ng-model="newsColumn.type">
				...
				<label for="firstname" class="col-sm-2 control-label">所属类别：<font
						color="red">*</font></label>
				<div class="col-sm-3">
					<select class="form-control" required name="column" ng-model="newsColumn.columnId">
						<option value="">--请选择--</option>
						<option ng-repeat="columnInfo in columnListInfo" value="{{columnInfo.id}}" ng-model="columnInfo.id">{{columnInfo.name}}</option>
					</select>
				</div>
				</div>
  			</div>
				...
				<div ng-repeat="newsColumnLan in newsColumnList">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
						  ...
						  ng-model="newsColumnLan.remark" maxlength="1000" class="input-xlarge isSpace" rows="5" style="width:800px;resize:none;"></textarea>
						</div>
					</div>
					</div>
				</div>
