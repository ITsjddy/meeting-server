...
<head>
	...
	<title>议题详情页面</title>
	<!-- 模块js -->
	<script src="${ctx }/static/sysviews/issue/js/detail.js"></script>
...
<body ng-app="issueApp" ng-controller="issueController">
   <ul class="breadcrumb"><li>议题详情页面</li></ul>
 <div id="wrapper">
	<div id="page-wrapper">
		...
		<div class="panel panel-default">
			...
			<div class="form-group"> 
  			...
  			<div class="form-group"> 
				...
				<div class="col-sm-3"> 
					<input type="text" placeholder="开始时间" disabled onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" class="form-control" autofocus id="startDate" name="startDate" ng-model="issue.issueStartDate"/>
				</div> 
				<label for="firstname" class="col-sm-2 control-label">结束时间：<font color="red">*</font></label> 
				<div class="col-sm-3"> 
					<input type="text" placeholder="结束时间" disabled onclick="WdatePicker({minDate:'#F{$dp.$D(\'startDate\')}',dateFmt:'yyyy-MM-dd HH:mm'})" class="form-control" autofocus id="endDate" name="endDate" ng-model="issue.issueEndDate" />
				</div> 
  			</div>
			<div class="form-group"> 
				<label for="firstname" class="col-sm-2 control-label">会场名称：<font color="red">*</font></label> 
				<div class="col-sm-3"> 
					<select class="form-control" disabled ng-change="changeConHallId()" name="conHallId" ng-model="issue.conHallId">
  			...
  			<div class="form-group"> 
				...
				<div class="col-sm-3"> 
					<input type="text" placeholder="会场联系人" disabled class="form-control" ng-model="conHallPerson" autofocus disabled/>
				</div> 
				<label for="firstname" class="col-sm-2 control-label">联系人电话：<font color="red">*</font></label> 
				<div class="col-sm-3"> 
					<input type="text" placeholder="联系人电话" disabled ng-model="conHallPersonMoblile" class="form-control" disabled />
				</div> 
  			</div>
			<div class="form-group">
				...
				<div class="col-sm-3">
					<select class="form-control" disabled  name="scheduleId"
  			...
  			<!-- 中文信息 -->
				<div class="panel panel-default">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" disabled placeholder="议题名称" class="form-control"
						...
						<div class="col-sm-3">
							<input type="text" disabled placeholder="主持人" class="form-control"
							 autofocus ng-model="issue.hostPerson" maxlength="60" />
						</div>
					</div>
					<div class="form-group">
						<label for="firstname" disabled class="col-sm-2 control-label">
							议题描述：<!-- <font color="red">*</font> -->
						</label>
						<div class="col-sm-3">
							<textarea type="text" disabled placeholder="议题描述" class="form-control"
							 autofocus ng-model="issue.remark" maxlength="60" maxlength="1000" class="input-xlarge isSpace" rows="5" style="width:800px;resize:none;"></textarea>
						</div>
					</div>
				</div>
				...
				<div ng-repeat="issueLan in issueList">
					<div class="panel panel-default" id="guestDiv{{$index}}"
						...
						<div class="col-sm-3">
							<input type="text" disabled placeholder="议题名称({{languageData[$index].name}})" class="form-control"
						...
						<div class="col-sm-3">
							<input type="text" disabled placeholder="主持人({{languageData[$index].name}})" class="form-control"
							 autofocus ng-model="issueLan.hostPerson" maxlength="60" />
						</div>
					</div>
					<div class="form-group">
						<label for="firstname" class="col-sm-2 control-label"> 
						...
						<div class="col-sm-3">
							<textarea type="text" disabled placeholder="议题描述({{languageData[$index].name}})" class="form-control"
							 autofocus ng-model="issueLan.remark" maxlength="60" maxlength="1000" class="input-xlarge isSpace" rows="5" style="width:800px;resize:none;"></textarea>
						</div>
					</div>
					</div>
				</div>
