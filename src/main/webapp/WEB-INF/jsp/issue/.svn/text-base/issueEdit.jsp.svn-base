...
<head>
	<meta charset="utf-8"> 
	<title>议题编辑页面</title>
	<script src="${ctx }/static/sysviews/issue/js/edit.js"></script>
...
<body ng-app="issueApp" ng-controller="issueController">
  <ul class="breadcrumb"><li>议题编辑页面</li></ul>
 <div id="wrapper">
	<div id="page-wrapper">
		...
		<div class="panel panel-default">
			...
			<div class="form-group"> 
  			...
  			<div class="form-group"> 
				...
				<div class="col-sm-3"> 
					<input type="text" required placeholder="开始时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" class="form-control"  id="startDate" name="startDate" ng-model="issue.issueStartDate"/>
				</div> 
				<label for="firstname" class="col-sm-2 control-label">结束时间：<font color="red">*</font></label> 
				<div class="col-sm-3"> 
					<input type="text" required placeholder="结束时间" onclick="WdatePicker({minDate:'#F{$dp.$D(\'startDate\')}',dateFmt:'yyyy-MM-dd HH:mm'})" class="form-control"  id="endDate" name="endDate" ng-model="issue.issueEndDate" />
				</div> 
  			</div>
			<div class="form-group"> 
				<label for="firstname" class="col-sm-2 control-label">会场名称：<font color="red">*</font></label> 
				<div class="col-sm-3"> 
					<select class="form-control" required ng-change="changeConHallId()" name="conHallId" ng-model="issue.conHallId">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" placeholder="议题名称" class="form-control"
								required  ng-model="issue.issueName" maxlength="60" />
						</div>
						...
						<div class="col-sm-3">
							<input type="text" placeholder="主持人" class="form-control"
							  ng-model="issue.hostPerson" maxlength="60" />
						</div>
					</div>
					<div class="form-group">
						<label for="firstname" class="col-sm-2 control-label">
						...
						<div class="col-sm-3">
							<textarea type="text" placeholder="议题描述" class="form-control"
							  ng-model="issue.remark" maxlength="60" maxlength="1000" class="input-xlarge isSpace" rows="5" style="width:800px;resize:none;"></textarea>
						</div>
					</div>
				</div>
					...
					<div class="panel panel-default" id="guestDiv{{$index}}"
						...
						<div class="col-sm-3">
							<input type="text" placeholder="议题名称({{languageData[$index].name}})" class="form-control"
								required  ng-model="issueLan.issueName" maxlength="60" />
						</div>
							<label for="firstname" class="col-sm-2 control-label"> <!-- <div ng-if="conHall.language=='1'">会场名称：<font color="red">*</font></div><div ng-if="conHall.language=='2'">name：<font color="red">*</font></div> -->
						...
						<div class="col-sm-3">
							<input type="text" placeholder="主持人({{languageData[$index].name}})" class="form-control"
							  ng-model="issueLan.hostPerson" maxlength="60" />
						</div>
					</div>
					<div class="form-group">
						<label for="firstname" class="col-sm-2 control-label"> 
						...
						<div class="col-sm-3">
							<textarea type="text" placeholder="议题描述({{languageData[$index].name}})" class="form-control"
							  ng-model="issueLan.remark" maxlength="60" maxlength="1000" class="input-xlarge isSpace" rows="5" style="width:800px;resize:none;"></textarea>
						</div>
					</div>
					</div>
				</div>
