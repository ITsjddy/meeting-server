		...
		<div class="panel panel-default">
			...
			<div class="form-group"> 
  			...
  			<div class="form-group"> 
				...
				<div class="col-sm-3"> 
					<input type="text" required placeholder="开始时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" class="form-control"  id="startDate" name="startDate" ng-model="issue.startDate"/>
				</div> 
				<label for="firstname" class="col-sm-2 control-label">结束时间：<font color="red">*</font></label> 
				<div class="col-sm-3"> 
					<input type="text" required placeholder="结束时间" onclick="WdatePicker({minDate:'#F{$dp.$D(\'startDate\')}',dateFmt:'yyyy-MM-dd HH:mm'})" class="form-control"  id="endDate" name="endDate" ng-model="issue.endDate" />
				</div> 
  			</div>
			<div class="form-group"> 
				<label for="firstname" class="col-sm-2 control-label">会场名称：<font color="red">*</font></label> 
				<div class="col-sm-3"> 
					<select class="form-control" ng-change="changeConHallId()" required name="conHallId" ng-model="issue.conHallId">
