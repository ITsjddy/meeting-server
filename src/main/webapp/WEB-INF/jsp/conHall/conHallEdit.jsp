	...
	<div id="page-wrapper">
		...
		<div class="panel panel-default">
			...
			<div class="form-group"> 
				...
				<div class="col-sm-3">
					<select class="form-control" required name="type" ng-model="conHall.type">
				...
				<div class="col-sm-3">
					<input type="text" placeholder="会场面积" class="form-control"
						required  ng-model="conHall.area" oninput="setCustomValidity('')" oninvalid="setCustomValidity('请为会场面积输入数值类型')" pattern="^[1-9]\d*\.\d*|0\.\d*[1-9]\d*$"  maxlength="60" />
				</div>
  			</div>
			<div class="form-group"> 
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" placeholder="会场联系人电话" class="form-control"
								ng-model="conHall.venueMobile"  oninput="setCustomValidity('')" oninvalid="setCustomValidity('手机号格式不正确')"  pattern="^((\+?86)|(\(\+86\)))?1\d{10}$"/>
						</div>
					</div>
				</div>
				<!-- 其他语言信息 -->
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" placeholder="会场联系人电话({{languageData[$index].name}})" class="form-control"
								ng-model="conHallLan.venueMobile" oninput="setCustomValidity('')" oninvalid="setCustomValidity('手机号格式不正确')"  pattern="^((\+?86)|(\(\+86\)))?1\d{10}$"/>
						</div>
					</div>
					</div>
				</div>
