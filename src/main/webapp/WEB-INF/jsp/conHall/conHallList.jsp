                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
								<div id="dataTables-example_filter" class="dataTables_filter">
									<label>会场名称:<input type="search"  ng-model="searchParam.name"
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
									...
									<td><input type="checkbox" ng-model="conHall.check" ng-change="idSelect(conHall.id,conHall.check)" ></td>
										...
										<td ng-repeat="conHallType in conHallTypeList" ng-if="conHall.type==conHallType.dDLogo" ng-bind="conHallType.dDName"></td>
