...
<html style="overflow-x: hidden; overflow-y: auto;">
	...
	<head>
		...
		<script src="${ctx }/static/sysviews/systemSetting/js/edit.js"></script>
			...
			<div id="page-wrapper">
					...
					<div class="panel panel-default">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input class="form-control" id="uniqueId" required  oninput="setCustomValidity('');"  type="text" name="uniqueId" ng-model="systemSetting.uniqueId"  ng-tlogos="uniqueId"/>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea class="required" required  ng-model="systemSetting.content" name="content" rows="4" cols="1000" 
