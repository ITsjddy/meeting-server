												...
												<ul class="dropdown-menu">
													...
													<%-- </security:authorize> --%>
														<security:authorize access="hasRole('PER_SERVICE_EDIT')">
															<li class="divider"></li>
															<li><a data-toggle="modal" data-target="#myPassword" ng-click="editPassword(audience.member.memberId,audience.member.invitationCode)" class="btn btn btn-info">修改密码</a></li>
														</security:authorize>
												</ul>
									    	</div>
										</td>
