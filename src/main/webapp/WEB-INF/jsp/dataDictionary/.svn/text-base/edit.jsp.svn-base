...
<html style="overflow-x: hidden; overflow-y: auto;">
	...
	<head>
		...
		<script src="${ctx }/static/sysviews/dataDictionary/js/edit.js"></script>
				...
				<form class="form-horizontal"  role="form" name="form" ng-submit="editDataDictionary()">
					<div class="panel panel-default">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input class="form-control" id="dDName" required oninput="setCustomValidity('');" type="text" name="dDName" ng-model="dataDictionary.dDName" ng-tames="dDName"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input class="form-control" id="dDLogo" required   oninput="setCustomValidity('');"  type="text" name="dDLogo" ng-model="dataDictionary.dDLogo" ng-tlogos="dDLogo"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="ds_host">排序标识：</label>
							<div class="col-sm-4">
								<input class="form-control" id="dDNum" required   type="number" name="dDNum" ng-model="dataDictionary.dDNum"/>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea class="required autofocus" required  ng-model="dataDictionary.dDexplanation" name="dDexplanation" rows="4" cols="1000" 
