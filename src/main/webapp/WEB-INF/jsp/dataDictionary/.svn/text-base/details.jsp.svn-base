...
<html style="overflow-x: hidden; overflow-y: auto;">
	...
	<head>
		...
		<script src="${ctx }/static/sysviews/dataDictionary/js/details.js"></script>
				...
				<form class="form-horizontal"  role="form" name="form" ng-submit="editDataDictionary()">
					<div class="panel panel-default">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea class="required autofocus" disabled autofocus ng-model="dataDictionary.dDexplanation" name="dDexplanation" rows="4" cols="1000" 
