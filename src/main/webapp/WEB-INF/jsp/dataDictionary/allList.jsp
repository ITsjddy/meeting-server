...
<html style="overflow-x: hidden; overflow-y: auto;">
	...
	<head>
		...
		<script src="${ctx }/static/sysviews/dataDictionary/js/allList.js"></script>
		<title>短信模板</title>
	</head>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<div id="dataTables-example_filter" class="dataTables_filter">
										<label>字典类型：</label>&nbsp;&nbsp;
										<label><select class="form-control"  name="dDTypeLogo" ng-model="searchParam.dDTypeLogo" >
										<option value="" > 请选择类型 </option>
										<option ng-repeat="type in findAllType" value="{{type.dTypeLogo}}" >{{type.dTypeName}}</option>
										</select>
										</label> &nbsp;&nbsp;
										<label>名称：&nbsp;&nbsp;<input type="search" ng-model="searchParam.dDName" class="input-sm">
										</label> &nbsp;&nbsp;
										...
										<a href="${ctx }/dispatcher/dataDictionary/allAdd" class="btn btn-primary">新建</a>
										&nbsp;&nbsp;
												...
												<td style="width:3%">
													<div class="btn-group">
														...
														<ul class="dropdown-menu" style="min-width: 110px;">
															<li><a href="${ctx }/dispatcher/dataDictionary/allEdit?id={{DataDictionary.dDcommId}}" class="btn btn-info">编辑</a></li>
															<li class="divider"></li>
															<li><a href="${ctx }/dispatcher/dataDictionary/allDetails?id={{DataDictionary.dDcommId}}" class="btn btn-success">详情</a></li>
															<li class="divider"></li>
