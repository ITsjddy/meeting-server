...
<head>
	...
	<!-- 模块js -->
	<script src="${ctx }/static/sysviews/template/js/deptlist.js"></script>
</head>
<body ng-app="guestApp" ng-controller="guestController">
	<ul class="breadcrumb"><li>团导入模板管理</li></ul>
	<div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-heading">
								<div id="dataTables-example_filter" class="dataTables_filter">
									...
									<security:authorize access="hasRole('ROLE_GUEST_ADD')">
										<a href="${ctx }${path}/depttemplate/add" class="btn btn-primary">新建</a>
									</security:authorize>
									<security:authorize access="hasRole('ROLE_GUEST_ADD')">
										<a href="${ctx }${path}/depttemplate/createindex" class="btn btn-primary">导入</a>
									</security:authorize>
								</div>
						</div>
                        <!-- /.panel-heading -->
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
												  	<security:authorize access="hasRole('ROLE_GUEST_EDIT')">
														<li><a href="${ctx }${path}/depttemplate/edit?id={{ guest.id }}" class="btn btn btn-info">编辑</a></li>
													</security:authorize>
													<security:authorize access="hasRole('ROLE_GUEST_EDIT')">
														<li class="divider"></li>
