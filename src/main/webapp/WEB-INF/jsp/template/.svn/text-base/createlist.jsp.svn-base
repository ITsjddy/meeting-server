...
<script src="${ctx }/static/sysviews/template/js/createlist.js"></script>	
		    ...
		    <div class="modal-dialog" style="width:870px;height:420px;">
		        <div class="modal-content">
		           <div class="modal-header">
		            ...
		            <iframe name="selectMember" id="selectMember"src="${ctx }/dispatcher/depttemplate/deptimportlist" style="width:100%;height:420px;">
                    </iframe>
	...
	<div id="page-wrapper">
		<form class="form-horizontal" role="form">
			...
			<div class="form-group"> 
				<label for="firstname" class="col-sm-2 control-label">团信息导入：<font color="red">*</font></label> 
				<div class="col-sm-3"> 
