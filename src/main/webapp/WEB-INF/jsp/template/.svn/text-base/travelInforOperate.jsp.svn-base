...
<html style="overflow-x:hidden;overflow-y:auto;">
	...
	<head>
		...
		<script src="${ctx }/static/sysviews/template/js/travelInforOperate.js"></script>
	</head>
			...
			<div id="page-wrapper">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						<label for="firstname" class="col-sm-2 control-label">实体字段名称：<font
						color="red">*</font></label>
						<div class="col-sm-3">
							<select class="form-control" ng-change="changeConHallId()" name="conHallId" id="conHallId" ng-model="schedule.conHallId">
							<option value="">--请选择--</option>
							<option ng-repeat="val in guest" value="{{val}}"
								ng-model="conHall.conHallId">{{val}}</option>
						</select>
						</div>
						<label for="firstname" class="col-sm-2 control-label">自定义名称：</label>
						<div class="col-sm-3">
							<input type="text" placeholder="自定义名称" class="form-control" autofocus id="endepartname" name="endepartname" ng-model="template.fieldName" maxlength="220" />
						</div>
					</div>
					<div class="form-group">
						<label for="firstname" class="col-sm-2 control-label">模板字段名称：<font
						color="red">*</font></label>
						<div class="col-sm-8">
