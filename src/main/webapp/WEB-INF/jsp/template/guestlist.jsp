...
<head>
	...
	<!-- 模块js -->
	<script src="${ctx }/static/sysviews/template/js/guestlist.js"></script>
</head>
                        ...
                        <div class="panel-heading">
								<div id="dataTables-example_filter" class="dataTables_filter">
									...
									<security:authorize access="hasRole('ROLE_GUEST_ADD')">
										<a href="${ctx }${path}/guesttemplate/add" class="btn btn-primary">新建</a>
									</security:authorize>
									<security:authorize access="hasRole('ROLE_GUEST_ADD')">
										<a href="${ctx }${path}/guesttemplate/createindex" class="btn btn-primary">导入</a>
									</security:authorize>
								</div>
						</div>
                        <!-- /.panel-heading -->
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
												  	<security:authorize access="hasRole('ROLE_GUEST_EDIT')">
														<li><a href="${ctx }${path}/guesttemplate/edit?id={{ guest.id }}" class="btn btn btn-info">编辑</a></li>
													</security:authorize>
