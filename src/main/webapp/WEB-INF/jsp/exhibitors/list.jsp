											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													...
													<security:authorize access="hasRole('PER_SERVICE_EDIT')">
															<li class="divider"></li>
															<li><a data-toggle="modal" data-target="#myPassword" ng-click="editPassword(exhibitors.member.memberId,exhibitors.member.invitationCode)" class="btn btn btn-info">修改密码</a></li>
														</security:authorize>
												</ul>
									    	</div>
										</td>
