...
<ul class="breadcrumb">
	<li>
		<c:choose>
		    <c:when test="${empty id}">展商信息添加</c:when>
		    <c:otherwise>展商信息修改</c:otherwise>   
		</c:choose>
	</li>
</ul>
<div id="wrapper">
	<div id="page-wrapper">
		<form class="form-horizontal" role="form" ng-submit="exhibitorsSave()">
			...
			<div class="panel panel-default">
				...
				<div class="form-group"> 
					...
					<input type="text" id="invitationCode" placeholder="邀请码" class="form-control" oninput="setCustomValidity('');"
						required autofocus ng-model="exhibitors.invitationCode" maxlength="220" <c:if test="${not empty id}">readonly</c:if>/>
<!-- 						<input type="text" placeholder="邀请码" class="form-control" required autofocus ng-model="exhibitors.invitationCode" maxlength="220" /> -->
					</div> 
					<c:if test="${empty id}">
					...
					<input type="text" oninvalid="setCustomValidity('密码 只能由数字、字母或_下划线组成，长度要在5到15之间！');" oninput="setCustomValidity('');" pattern="^[0-9a-zA-Z_]{5,15}$"
							required autofocus placeholder="密码 只能由数字、字母或_下划线组成，长度要在5到15之间！" class="form-control" ng-model="exhibitors.password" maxlength="20" />
<!-- 						<input type="text" placeholder="密码 只能由数字、字母或_下划线组成，长度要在5到15之间！" class="form-control" autofocus ng-model="exhibitors.password" maxlength="220" /> -->
					</div> 
					</c:if>
	  			...
	  			<label for="firstname" class="col-sm-2 control-label">用户名：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="用户名" class="form-control" autofocus ng-model="exhibitors.userName" maxlength="220" />
					</div> 
	  				<label for="firstname" class="col-sm-2 control-label">手机号：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="手机号" class="form-control" autofocus ng-model="exhibitors.mobile" maxlength="220" />
					</div> 
	  			</div>
	  			<div class="form-group">
	  			<label for="firstname" class="col-sm-2 control-label">email：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="email" class="form-control" autofocus ng-model="exhibitors.email" maxlength="220" />
					</div> 
	  				<label for="firstname" class="col-sm-2 control-label">性别：</label> 
					<div class="col-sm-3"> 
						男&nbsp;<input type="radio" placeholder="性别" autofocus ng-model="exhibitors.gender" value="1" ng-checked="isSelected(exhibitors.gender)"/>&nbsp;&nbsp;
						女&nbsp;<input type="radio" placeholder="性别" autofocus ng-model="exhibitors.gender" value="2" ng-checked="isSelected(exhibitors.gender)"/>
					</div> 
	  			</div>
			</div>
			<div class="panel panel-default">
				<ul class="breadcrumb">
	  			...
	  			<div class="form-group"> 
					...
					<div class="col-sm-3"> 
						<input type="text" placeholder="姓名" class="form-control" required autofocus ng-model="exhibitors.name" maxlength="220" />
					</div> 
	  			</div>
	  			<div class="form-group"> 
					<label for="firstname" class="col-sm-2 control-label">工作单位：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="工作单位" class="form-control" autofocus ng-model="exhibitors.workPlace" maxlength="220" />
					</div> 
					<label for="firstname" class="col-sm-2 control-label">职位：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="职位" class="form-control" autofocus ng-model="exhibitors.job" maxlength="220" />
					</div> 
	  			</div>
	  			<div class="form-group"> 
	  				<label for="firstname" class="col-sm-2 control-label">单位简介：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="单位简介" class="form-control" autofocus id="unitExplain" name="unitExplain" ng-model="exhibitors.unitExplain" maxlength="220" />
					</div> 
					<label for="firstname" class="col-sm-2 control-label">个人简介：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="个人简介" class="form-control" autofocus id="introduction" name="introduction" ng-model="exhibitors.introduction" maxlength="220" />
					</div> 
	  			</div>
	  			<div class="form-group"> 
	  				<label for="firstname" class="col-sm-2 control-label">联系人：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="联系人" class="form-control" autofocus id="contactPerson" name="contactPerson" ng-model="exhibitors.contactPerson" maxlength="220" />
					</div> 
					<label for="firstname" class="col-sm-2 control-label">联系人电话：</label> 
					<div class="col-sm-3"> 
						<input type="text" placeholder="联系人电话" class="form-control" autofocus id="contactPhone" name="contactPhone" ng-model="exhibitors.contactPhone" maxlength="220" />
					</div> 
	  			</div>
			</div>
				<!-- 内容 -->
					...
					<ul class="breadcrumb">
		  			...
		  			<div class="form-group"> 
						...
						<span ng-if="languageData[$index].check == true">
							<input type="text" placeholder="姓名" class="form-control" required autofocus ng-model="exhibitorslan.name" maxlength="220" />
							</span>
						</div> 
		  			...
		  			<div class="form-group"> 
						...
						<div class="col-sm-3"> 
							<input type="text" placeholder="工作单位" class="form-control" autofocus ng-model="exhibitorslan.workPlace" maxlength="220" />
						</div> 
						<label for="firstname" class="col-sm-2 control-label">职务({{languageData[$index].name}})：</label> 
						<div class="col-sm-3"> 
							<input type="text" placeholder="职务" class="form-control" autofocus ng-model="exhibitorslan.job" maxlength="220" />
						</div> 
		  			</div>
		  			<div class="form-group"> 
						<label for="firstname" class="col-sm-2 control-label">单位简介({{languageData[$index].name}})：</label> 
						<div class="col-sm-3"> 
							<input type="text" placeholder="单位简介" class="form-control" autofocus ng-model="exhibitorslan.unitExplain" maxlength="220" />
						</div> 
						<label for="firstname" class="col-sm-2 control-label">个人简介({{languageData[$index].name}})：</label> 
						<div class="col-sm-3"> 
							<input type="text" placeholder="个人简介" class="form-control" autofocus ng-model="exhibitorslan.introduction" maxlength="220" />
						</div> 
		  			</div>
		  			<div class="form-group"> 
	  					<label for="firstname" class="col-sm-2 control-label">联系人({{languageData[$index].name}})：</label> 
						<div class="col-sm-3"> 
							<input type="text" placeholder="联系人" class="form-control" autofocus id="contactPerson" name="contactPerson" ng-model="exhibitorslan.contactPerson" maxlength="220" />
						</div> 
						<label for="firstname" class="col-sm-2 control-label">联系人电话({{languageData[$index].name}})：</label> 
						<div class="col-sm-3"> 
							<input type="text" placeholder="联系人电话" class="form-control" autofocus id="contactPhone" name="contactPhone" ng-model="exhibitorslan.contactPhone" maxlength="220" />
						</div> 
	  				</div>
				</div>
			</div>
