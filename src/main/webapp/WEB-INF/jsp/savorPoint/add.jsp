...
<html style="overflow-x: hidden; overflow-y: auto;">
	...
	<head>
		...
		<script src="${ctx }/static/sysviews/savorPoint/js/add.js"></script>
			...
			<div id="page-wrapper">
				<form class="form-horizontal"  role="form"  enctype="multipart/form-data" name="form" ng-submit="addSavorPoint()">
					<div class="panel panel-default">
						...
						<hr/>
						<input type="hidden" value="${spOnly}" id="spValue">
						<div class="form-group">
							<label class="col-sm-2 control-label" for="ds_host">唯一标识：</label>
							<div class="col-sm-4">
								<input class="form-control" id="spOnly" required  autofocus oninput="setCustomValidity('');"  type="text" name="spOnly" ng-model="savorPoint.spOnly" ng-tlogos="spOnly"/>
							</div>
						</div>
						<div class="form-group">
							<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="spType"  ng-model="savorPoint.spType" required class="form-control">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input class="form-control" required autofocus type="text" name="spName" ng-model="savorPoint.spName" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="ds_host">中文地址：</label>
							<div class="col-sm-4">
								<input class="form-control" required autofocus type="text" name="spAddress" ng-model="savorPoint.spAddress" />
							</div>
						</div>
						<div class="form-group">
								...
								<div ng-repeat="topic in spAddressNames">
									...
									<div id="optionsDiv{{topicMark+1}}" style="display: none;">
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="text" ng-if="topic.topicType.length > 0" required autofocus class="form-control" name="topic{{topicMark+1}}Option{{$index + 1}}" ng-model="topic.spName" id="topic{{topicMark+1}}Option{{$index + 1}}" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-1 control-label" for="ds_host">地址：</label>
											<div class="col-sm-4">
												<input type="text"  ng-if="topic.topicType.length > 0" required autofocus class="form-control" ng-model="topic.spAddress" id="topic{{topicMark+11}}Option{{$index + 1}}" />
											</div>
										</div>
									</div>
								</div>
