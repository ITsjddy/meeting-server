									...
									<table id="spTable" class="table table-striped table-bordered table-hover " style="text-align:center">
										...
										<tbody>
											<tr ng-repeat="savorPoint in items">
												<td style="width:2%"><input type="checkbox" ng-model="savorPoint.check" ng-change="idSelect(savorPoint.spUniteId,savorPoint.check)" ></td>
												...
												<td style="width:7%">
													<div class="btn-group" >
														...
														<ul class="dropdown-menu" style="min-width: 110px;">
															...
															<li class="divider"></li>
															<li><a href="${ctx }/dispatcher/savorPoint/details?spUniteId={{ savorPoint.spUniteId }}" class="btn btn btn-success">详情</a></li>
															<li class="divider"></li>
