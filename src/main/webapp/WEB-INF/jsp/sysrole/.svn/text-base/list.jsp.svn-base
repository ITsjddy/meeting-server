                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
								<div id="dataTables-example_filter" class="dataTables_filter">
									<label>名称:</label>
									<label>
										<input type="search" ng-model="searchParam.name" class="input-sm" >
									</label>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
									<tr ng-repeat="role in items">
										<td><input type="checkbox" ng-model="role.check" ng-change="idSelect(role.id,role.check)" ></td>
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													...
													<security:authorize access="hasRole('ROLE_SYS_GROUP_DELETE')">
														<li class="divider"></li>
														<li><a href="${ctx }${path}/sysRole/indexUsers?id={{ role.id }}" class="btn btn btn-success">用户</a></li>
													</security:authorize>
												</ul>
									    	</div>
										</td>
