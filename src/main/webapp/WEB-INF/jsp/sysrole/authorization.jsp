...
<link rel="stylesheet" href="${ctx}/static/jsTree/themes/default/style.min.css" />
...
<script src="${ctx }/static/sysviews/sysrole/js/authorization.js"></script>
			...
			<form class="form-horizontal" role="form">
				...
				<div class="form-group breadcrumb" style="width:100%;float:left;margin:10px;">
					<div class="col-sm-offset-2 col-sm-10"> 
						<input id="btnSubmit" class="btn btn-primary" type="button" ng-click="authorizationSave()" value="保 存"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
