...
<body ng-app="sysRoleApp" ng-controller="sysRoleController" style="width:100%;height:100%;margin:10px">
	...
	<div id="wrapper">
		<div id="page-wrapper">
			<form class="form-horizontal" role="form" ng-submit="sysRoleSave()">
				...
				<div class="form-group"> 
	  			...
	  			<div class="form-group"> 
					...
					<div class="col-sm-3"> 
						<textarea placeholder="备注" rows="5" class="form-control" autofocus rows="3" cols="3" id="remark" name="remark" maxlength="900" ng-model="sysRole.remark"></textarea>
					</div> 
	  			</div>
	  			<!-- 保存、返回 -->
