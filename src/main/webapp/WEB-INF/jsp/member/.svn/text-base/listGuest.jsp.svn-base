...
<head>
	...
	<!-- 模块js -->
	<script src="${ctx }/static/sysviews/member/js/listGuest.js"></script>
</head>
                        ...
                        <div class="panel-heading">
								<div id="dataTables-example_filter" class="dataTables_filter">
									...
									<security:authorize access="hasRole('ROLE_SYS_GROUP_ADD')">
										<a href="${ctx }${path}/member/addGuest" class="btn btn-primary" >新建</a>
									</security:authorize>
								</div>
						</div>
                        <!-- /.panel-heading -->
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
												  	<security:authorize access="hasRole('ROLE_SYS_ROLE_EDIT')">
														<li><a href="${ctx }${path}/member/editGuest?id={{ guest.id }}" class="btn btn btn-info">编辑</a></li>
													</security:authorize>
													...
													<security:authorize access="hasRole('ROLE_SYS_ROLE_DETAILS')">
														<li class="divider"></li>
														<li><a href="${ctx }${path}/member/detailsGuest?id={{ role.id }}" class="btn btn btn-info">详情</a></li>
													</security:authorize>
												</ul>
									    	</div>
										</td>
