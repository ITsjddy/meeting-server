	...
	<div id="page-wrapper">
		...
		<div class="panel panel-default">
  			...
  			<div class="form-group">
				...
				<div class="col-sm-3">
					<textarea type="text" placeholder="简介({{languageName}})" class="form-control"
								required  ng-model="news.remark" maxlength="60" maxlength="1000" class="input-xlarge isSpace" rows="5" style="width:800px;resize:none;"></textarea>
				</div>
			</div>
			<div class="form-group">
			<label for="firstname" class="col-sm-2 control-label">排序({{languageName}})：<font
							color="red">*</font></label>
						<div class="col-sm-3">
							<input type="text" required oninput="setCustomValidity('')" oninvalid="setCustomValidity('请输入正整数')" pattern="^[1-9]\d*$" class="form-control" placeholder="排序({{languageName}})" ng-model="news.sortNumber" />
						</div>
