...
<head>
	...
	<!-- 模块js -->
	<script src="${ctx }/static/sysviews/publicshComment/js/detailOfpl.js"></script>
	...
	<div id="page-wrapper">
		<form class="form-horizontal" role="form">
			...
			<div class="panel panel-default">
				<ul  class="breadcrumb">
					<li  style="color:blue;">主题详情：</li>
				</ul>
				<div ng-repeat="subject in publicshCom.subject">
					<div class="form-group"> 
						<label for="firstname" class="col-sm-2 control-label">发布内容：</label> 
						<div class="col-sm-8"> 
							<textarea placeholder="发布内容" class="form-control" autofocus ng-model="subject.message" maxlength="220" readonly="readonly"></textarea>
						</div> 
		  			</div>
		  			<div class="form-group">
		  				<label for="firstname" class="col-sm-2 control-label">发布人：</label> 
		  				<div class="col-sm-3">
		  					<input type="text" placeholder="发布人" class="form-control" autofocus ng-model="subject.member.name" maxlength="220" readonly="readonly"/>
		  				</div>
		  			</div>
		  			<div class="form-group"> 
		  				<label for="firstname" class="col-sm-2 control-label">发布时间：</label> 
						<div class="col-sm-3"> 
							<input type="text" placeholder="发布时间" class="form-control" autofocus ng-model="subject.createTimes" maxlength="220" readonly="readonly"/>
						</div>
		  			</div>
	  			</div>
