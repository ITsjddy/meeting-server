...
<head>
	...
	<!-- 模块js -->
	<script src="${ctx }/static/sysviews/publicshComment/js/checkedListofpl.js"></script>
</head>
<body ng-app="publicshCommentApp" ng-controller="publicshCommentController">
	...
	<ul class="nav nav-tabs">
		<li class=""><a href="javaScript:void(0)" ng-click="index()" >未审核列表</a></li>
		<li class="active"><a href="javaScript:void(0)" ng-click="checkList()">已审核列表</a></li>
	</ul></br>
	</li>
	</ul>
	<div id="wrapper">
										...
										<td>
									    	<div class="btn-group">
												...
												<ul class="dropdown-menu">
												  	<li><a href="${ctx }${path}/publicshComment/detailsofpl?id={{ publics.id }}" class="btn btn btn-info">详情</a></li>
<!-- 												  	<li class="divider"></li> -->
