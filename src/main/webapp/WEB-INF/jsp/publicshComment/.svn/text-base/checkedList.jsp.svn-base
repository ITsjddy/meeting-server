...
<head>
	...
	<!-- 模块js -->
	<script src="${ctx }/static/sysviews/publicshComment/js/checkedList.js"></script>
</head>
...
<!-- 	<ul class="breadcrumb">
	...
	<ul class="nav nav-tabs">
		<!-- <li><a href="javaScript:void(0)" ng-click="index()" >未审核列表</a></li>
		<li><a href="javaScript:void(0)" ng-click="checkList()">已审核列表</a></li> -->
		<li class=""><a href="javaScript:;" ng-click="index()" >未审核列表</a></li>
		<li class="active"><a href="javaScript:;" ng-click="checkList()">已审核列表</a></li>
	</ul></br>
	</li>
	</ul>
	<div id="wrapper">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
								<div id="dataTables-example_filter" class="dataTables_filter">
									...
									<label>审核状态:
										<select class="form-control input-sm" type="search" placeholder="" aria-controls="dataTables-example" ng-model="searchParam.public_status">
											<option value=""></option>
											<option value="2" <c:if test="${'2'==searchParam.public_status}">selected</c:if> >通过</option>
											<option value="3" <c:if test="${'3'==searchParam.public_status}">selected</c:if> >未通过</option>    
										</select>
									</label>
