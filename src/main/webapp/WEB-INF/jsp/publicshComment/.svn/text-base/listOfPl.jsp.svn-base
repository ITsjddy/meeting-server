...
<head>
	...
	<!-- 模块js -->
	<script src="${ctx }/static/sysviews/publicshComment/js/listofpl.js"></script>
</head>
<body ng-app="publicshCommentApp" ng-controller="publicshCommentController">
	<ul class="nav nav-tabs">
		<li class="active"><a href="javaScript:void(0);" ng-click=changeListType(index())>未审核列表</a></li>
		<li class=""><a href="javaScript:void(0);" ng-click=changeListType(checkList())>已审核列表</a></li>
	</ul></br>
	<div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
