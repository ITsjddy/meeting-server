...
<div id="wrapper">
	<form class="form-horizontal" role="form" ng-submit="mediaSave()">
		...
		<div class="panel panel-default">
			...
			<div class="form-group"> 
				...
				<input type="text" id="invitationCode" placeholder="邀请码" class="form-control" oninput="setCustomValidity('');"
						required autofocus ng-model="media.invitationCode" maxlength="220" <c:if test="${not empty id}">readonly</c:if>/>
<!-- 					<input type="text" placeholder="邀请码" class="form-control" required autofocus ng-model="media.invitationCode" maxlength="220" /> -->
				...
				<input type="text" oninvalid="setCustomValidity('密码 只能由数字、字母或_下划线组成，长度要在5到15之间！');" oninput="setCustomValidity('');" pattern="^[0-9a-zA-Z_]{5,15}$"
							required autofocus placeholder="密码 只能由数字、字母或_下划线组成，长度要在5到15之间！" class="form-control" ng-model="media.password" maxlength="20" />
<!-- 					<input type="text" placeholder="密码" class="form-control" autofocus ng-model="media.password" maxlength="220" /> -->
				</div> 
				</c:if>
  			</div> 
  			<div class="form-group"> 
  			...
  			<label for="firstname" class="col-sm-2 control-label">用户名：</label> 
				<div class="col-sm-3"> 
				<input type="text" id="userName" placeholder="用户名" class="form-control"  autofocus ng-model="media.userName" maxlength="220" oninput="setCustomValidity('');"/>
