                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tr ng-repeat="media in items">
										<td><input type="checkbox" ng-model="media.check" ng-change="idSelect(media.id,media.check)" ></td>
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													...
													<security:authorize access="hasRole('PER_SERVICE_EDIT')">
															<li class="divider"></li>
															<li><a data-toggle="modal" data-target="#myPassword" ng-click="editPassword(media.member.memberId,media.member.invitationCode)" class="btn btn btn-info">修改密码</a></li>
														</security:authorize>
												</ul>
									    	</div>
										</td>
