...
function(a) { !
    function(a) {
            ...
            var h, i = this.each(function() {
                ...
                if (b.is("select")) {
                    ...
                    if (c) {
                        ...
                        var k = a.extend({},
                        g.DEFAULTS, a.fn.selectpicker.defaults || {},
                        b.data(), i);
                        k.template = a.extend({},
                        g.DEFAULTS.template, a.fn.selectpicker.defaults ? a.fn.selectpicker.defaults.template: {},
                        b.data().template, i.template),
                ...
                return this.$element.find("option").each(function(b) {
                    ...
                    if (h++, !c.hasClass("bs-title-option")) {
                        ...
                        if (c.data("content") || (l = o + '<span class="text">' + l + n + "</span>"), q && c.data("divider") !== !0) {
                            ...
                            y && (h++, e.push(i("", null, "divider", f + "div"))),
            ...
            clickListener: function() {
                ...
                function(c) {
                    ...
                    if (b.multiple && 1 !== b.options.maxOptions && c.stopPropagation(), c.preventDefault(), !b.isDisabled() && !d.parent().hasClass("disabled")) {
                        ...
                        b.setSelected(e, !0); ! b.multiple || b.multiple && 1 === b.options.maxOptions ? b.$button.focus() : b.options.liveSearch && b.$searchbox.focus(),
        ...
        a(document).data("keycount", 0).on("keydown.bs.select", '.bootstrap-select [data-toggle=dropdown], .bootstrap-select [role="listbox"], .bs-searchbox input', g.prototype.keydown).on("focusin.modal", '.bootstrap-select [data-toggle=dropdown], .bootstrap-select [role="listbox"], .bs-searchbox input',
        function(a) {
            a.stopPropagation()
        }),
