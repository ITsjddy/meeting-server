...
guestApp.controller("guestController", function($scope,$http,pageService) {
	...
	pageService.queryForList($scope,$http,CONTEXT_PATH+DISPATCHER_PATH+"/depttemplate/pageQuery");
	$scope.searchByParam = function(){
		pageService.reGetDataForList($scope,$http,CONTEXT_PATH+DISPATCHER_PATH+"/depttemplate/pageQuery");
	};
	$scope.guestDelete = function(id){
		var delurl = CONTEXT_PATH+DISPATCHER_PATH+"/depttemplate/deleteById";
