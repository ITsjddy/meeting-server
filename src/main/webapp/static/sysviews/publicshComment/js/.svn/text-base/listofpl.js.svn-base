...
publicshCommentApp.controller("publicshCommentController", function($scope,$http,pageService) {
	pageService.queryForList($scope,$http,CONTEXT_PATH+DISPATCHER_PATH+"/publicshComment/pageQuery?type=2");
	$scope.searchByParam = function(){
		pageService.reGetDataForList($scope,$http,CONTEXT_PATH+DISPATCHER_PATH+"/publicshComment/pageQuery?type=2");
	};
